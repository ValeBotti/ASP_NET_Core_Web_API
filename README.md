...
The problem: my Kotlin app couldn't retrieve data anymore because the server shut down. That meant I couldn't see my application properly working, and that's why I decided to start this project.
